function [reconstruction] = reconstruct_tv_it_cbg_withoutD(A,cscale, measurement, reg, NumBlocks, tik_reg)
%% Forms the scene reconstruction given a measurement image and using the A matrices.
  
   % Difference matrix --> identity matrix
   Diff = diag(ones(1,size(A,1)),0);
